    ...
    return (
        <>
            <div className="transition-all  ease-in-out duration-100 flex font-bold">
                <div onClick={() => {accordion.computation && setSelectedBtn(""); setAccordion({...accordion, computation: !accordion.computation})}} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
            ...
            </div>
            {
                ...
                <div className="">
                    ...
                    <div className="transition-all  ease-in-out duration-100 flex font-bold">
                    <div onClick={() => setAccordion({...accordion, pgbp: !accordion.pgbp})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                        <IoHome className="mx-1"/>
                    ...
                    <div>
                    <div className="transition-all  ease-in-out duration-100 flex font-bold">
                        <div onClick={() => setAccordion({...accordion, pgbpPresemptive: !accordion.pgbpPresemptive})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                        <IoHome className="mx-1"/>
                    ...
                    <div className="transition-all  ease-in-out duration-100 flex font-bold">
                    <div onClick={() => setAccordion({...accordion, captialGains: !accordion.captialGains})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                        <IoHome className="mx-1"/>
                    ...
                    <div className="transition-all  ease-in-out duration-100 flex font-bold">
                    <div onClick={() => setAccordion({...accordion, captialGainsShares: !accordion.captialGainsShares})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                        <IoHome className="mx-1"/>
                    ...
                    <div>
                    <div className="transition-all  ease-in-out duration-100 flex font-bold">
                    <div onClick={() => setAccordion({...accordion, captialGainsOtherAssets: !accordion.captialGainsOtherAssets})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                        <IoHome className="mx-1"/>
                    ...
                    <div className="transition-all  ease-in-out duration-100 flex font-bold">
                <div onClick={() => setAccordion({...accordion, taxThereon: !accordion.taxThereon})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                <IoHome className="mx-1"/>
            ...
            </div>
            {
                ...
                <div>
                <div className="transition-all  ease-in-out duration-100 flex font-bold">
                    <div onClick={() => setAccordion({...accordion, pgbpNormalIncom: !accordion.pgbpNormalIncom})} className="cursor-pointer px-0.5 flex items-center border font-normal">
                    <IoHome className="mx-1"/>
            ...
            <div className="transition-all  ease-in-out duration-100 flex font-bold">
                <div onClick={() => setAccordion({...accordion, netTax: !accordion.netTax})} className="cursor-pointer px-0.5 flex items-center border bg-blue-50 text-blue-500 hover:text-blue-700">
                <IoHome className="mx-1"/>
            ...
            </div>
            {
                ...
                <div>
                <div className="transition-all  ease-in-out duration-100 flex font-bold">
                    <div className="cursor-pointer px-0.5 flex items-center border font-normal">
                    <IoHome className="mx-1"/>
                    <span className={`${isOpen ? 'ml-5' : 'hidden'} w-[139px] flex gap-2  italic `}>Tax</span> 
                    {/* {accordion.pgbpNormalIncom ? <IoArrowDown  /> : <IoArrowUp  />}
                    */}
