    ...
    return (
        <>
            <div className="border border-x-0 border-b-0 border-gray-300">
                <div className="flex">
                    <p className="border-b border-gray-300 pl-6 pr-4 py-1 w-full">(a) Sale Of Product</p>
                    <div className=" flex">
            ...
            <div className="border border-x-0 border-b-0 border-gray-300">
                <div className="flex">
                    <p className="border-b border-gray-300 pl-6 pr-4 py-1 w-full">(b) Sale Of Services</p>
                    <div className="flex">
                        <EachSapn><span>Total Sales in Rs.</span> <strong>0/-</strong></EachSapn>
                        <EachSapn><span>Total Sales in Rs.</span> <strong>0/-</strong></EachSapn>
                    </div>
            ...
            <div className="border border-x-0 border-b-0 border-gray-300">
                <div className="flex">
                    <p className="border-b border-gray-300 pl-6 pr-4 py-1 w-full">(c) Grants or Donation Received</p>
                    <div className="flex">
            ...
            <div className="border border-x-0 border-b-0 border-gray-300">
                <div className="flex">
                    <p className="border-b border-gray-300 pl-6 pr-4 py-1 w-full">(d) Other Operating Revenue</p>
                    <div className="flex">
                        <EachSapn><span>Total Revenue in Rs.</span> <strong>0/-</strong></EachSapn>
                        <EachSapn><span>Total Revenue in Rs.</span> <strong>0/-</strong></EachSapn>
                    </div>
                </div>
                    ...
                    <div key={block.id} className="w-full flex justify-between">
                        ...
                        <div className="flex">
                            ...
                            <input
                                className="border-l border-r-0 border-b border-t-0 border-gray-300 !w-[200px] px-4 py-1"
                                value={block.inputs[2]}
                                onChange={(e) => handleInputChange(index, 2, e.target.value, blocksForOtherOperatingRevenue, setblocksForOtherOperatingRevenue)}
                            />
                        </div>
                    </div>
                ))}
            ...
            <div className="border border-x-0 border-b-0 border-gray-300">
                <div className="flex">
                    <p className="border-b border-gray-300 pl-6 pr-4 py-1 w-full">Revenue From Operations (Gross)</p>
                    <div className="flex">
                        <EachSapn><span>Total Revenue in Rs.</span> <strong>0/-</strong></EachSapn>
                        <EachSapn><span>Total Revenue in Rs.</span> <strong>0/-</strong></EachSapn>
                    </div>
                    ...
                    <div key={block.id} className="w-full flex justify-between">
                        ...
                        <div className="flex">
                            ...
                            <input
                                className="border-l border-r-0 border-b border-t-0 border-gray-300 !w-[200px] px-4 py-1"
                                value={block.inputs[2]}
                                onChange={(e) => handleInputChange(index, 2, e.target.value, blocksForRevenueFromOperations, setBlocksRevenueFromOperations)}
                            />
                        </div>
                    </div>
                ))}
            ...
            <div className="border border-x-0 border-b-0 border-gray-300">
                <div className="flex">
                    <p className="border-b border-gray-300 pl-6 pr-4 py-1 w-full">Less: Excise Duty</p>
                    <div className="flex">
                    <EachSapn><span>Total Duty in Rs.</span> <strong>0/-</strong></EachSapn>
                    <EachSapn><span>Total Duty in Rs.</span> <strong>0/-</strong></EachSapn>
                    </div>
                </div>
                    ...
                    <div key={block.id} className="w-full flex justify-between">
                        ...
                        <div className="flex">
                            ...
                            <input
                                className="border-l border-r-0 border-b border-t-0 border-gray-300 !w-[200px] px-4 py-1"
                                value={block.inputs[2]}
                                onChange={(e) => handleInputChange(index, 2, e.target.value, blocksForExciseDuty, setBlocksForExciseDuty)}
                            />
                        </div>
                    </div>
                ))}
