interface ItemDetails {
  ...
  return (
    <li className={`flex gap-2 items-center  transition-all mx-1.5 hover:text-black hover:bg-blue-300/50 px-2.5 py-1 border-b-2 border-amber-950 hover:scale-105`}>
