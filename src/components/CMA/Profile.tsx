...
export const Profile = () => {
  ...
  <div>
    ...
    <div className="mt-2 grid grid-cols-12">
      <ul className="mt-2 grid px-1.5 grid-cols-6 lg:col-span-6 md:col-span-10 col-span-12 gap-1 gap-x-5">
        {residentialAddress.map(address => (
          <li className="flex md:col-span-3 lg:col-span-3 col-span-6">
