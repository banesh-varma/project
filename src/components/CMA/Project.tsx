...
const Project = () => {
  ...
  return(
    <>
      <div className="col-span-12 md:col-span-8 lg:col-span-7 grid grid-cols-3 space-x-1">
  ...
  return (
    ...
    <div className="">
      ...
      <div className="grid grid-cols-12 px-1.5">
        <div className="col-span-12 md:col-span-8 lg:col-span-7 space-y-1">
          <div className="grid grid-cols-6 col-span-4 items-center">
            <label htmlFor="" className="col-span-2 lg:col-span-1">Name of Project</label>
            <input type="text" className="px-1.5 py-0.5 col-span-4 lg:col-span-5 border w-full" />
          </div>
          <div className="grid grid-cols-6 col-span-4 items-center">
            <label htmlFor="" className="col-span-2 lg:col-span-1">Bank Name</label>
            <input type="text" className="px-1.5 py-0.5 col-span-4 lg:col-span-5 border w-full" />
          </div>
          <div className="grid grid-cols-6 col-span-4 items-center">
            <label htmlFor="" className="col-span-2 lg:col-span-1">Branch Name</label>
            <input type="text" className="px-1.5 py-0.5 col-span-4 lg:col-span-5 border w-full" />
          </div>
        </div>
        <div className="col-span-12 md:col-span-8 lg:col-span-7 grid grid-cols-3 space-x-1">
